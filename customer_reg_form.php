...
if (isset($_POST['submit'])) {
	...
	// $data_validation = 0;
	// if (!preg_match("/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/", $_POST['pan_no'])) {
	// 	$pan_no_err = "It should be ten characters long.
	...
	// 	// echo $last_name_err;
	// 	$data_validation = 0;
	// 	echo "<script>alert('It should be ten characters long.
	// 	The first five characters should be any upper case alphabets.
	// 	The next four-characters should be any number from 0 to 9.
	// 	The last(tenth) character should be any upper case alphabet.
	// 	It should not contain any white spaces.')</script>";
	// } else {
