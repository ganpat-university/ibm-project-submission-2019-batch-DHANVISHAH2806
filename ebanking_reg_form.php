...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (
            ...
            $account_no = encrypt_data($_POST['accnum']);
            ...
            //Without Hashing
            $password = encrypt_data($_POST['password']);
            $cnfrm_password = encrypt_data($_POST['cnfrm_password']);
            ...
            if ($result1->num_rows > 0) {
                ...
                echo '$last_trans_cr'. $last_trans_cr = $row2['Cr_amount'];
                ...
                echo '$last_trans_dr'. $last_trans_dr = $row3['Dr_amount'];
                
                // echo 'this' . $row2['Cr_amount']. '!='. $last_trans || $row3['Dr_amount'] .'!='. $last_trans;
